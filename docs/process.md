...
|------|---------|-------------|-------|
| 2026-03-08 | S0.3 | Auth: Auth.js v5, GitHub OAuth, email allowlist. Protect /admin/ via layout. JWT sessions, no User model. | [src/auth.ts](src/auth.ts), [src/app/admin/](src/app/admin/), [docs/04-Architecture/auth.md](docs/04-Architecture/auth.md) |
